...
func (c *Client) GetUser(ctx context.Context, cn string) (*schema.Object, error) {
	...
	if err := c.DoWithContext(ctx, nil, &response, client.OptPath("user", cn)); err != nil {
		return nil, err
	}
	return types.Ptr(response), nil
}
...
func (c *Client) CreateUser(ctx context.Context, cn string, req *schema.ObjectPutRequest, allocateGID bool) (*schema.Object, error) {
	...
	if err := c.DoWithContext(ctx, body, &response, client.OptPath("user", cn), client.OptQuery(query)); err != nil {
		return nil, err
	}
	return types.Ptr(response), nil
}
...
func (c *Client) UpdateUser(ctx context.Context, cn string, req schema.ObjectPutRequest) (*schema.Object, error) {
	...
	if err := c.DoWithContext(ctx, body, &response, client.OptPath("user", cn)); err != nil {
		return nil, err
	}
	return types.Ptr(response), nil
}
...
func (c *Client) DeleteUser(ctx context.Context, cn string) (*schema.Object, error) {
	var response schema.Object
	if err := c.DoWithContext(ctx, client.MethodDelete, &response, client.OptPath("user", cn)); err != nil {
		return nil, err
	}
	return types.Ptr(response), nil
}
