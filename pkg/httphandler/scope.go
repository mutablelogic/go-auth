...
// Return an http.HandlerFunc for the scope endpoint.
func ScopeHandler(mgr *manager.Manager) (string, http.HandlerFunc, *openapi.PathItem) {
				...
				Parameters: []openapi.Parameter{
					{
						...
						Description: "Filter scopes by substring match.",
...
func listScope(ctx context.Context, mgr *manager.Manager, w http.ResponseWriter, r *http.Request) error {
