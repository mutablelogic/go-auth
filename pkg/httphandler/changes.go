...
func ChangesHandler(mgr *manager.Manager) (string, http.HandlerFunc, *openapi.PathItem) {
...
func streamChanges(ctx context.Context, mgr *manager.Manager, w http.ResponseWriter, r *http.Request) error {
