...
import (
	...
	certmanager "github.com/mutablelogic/go-auth/pkg/httpclient/certmanager"
...
func withUnauthenticatedClient(ctx server.Cmd, fn func(*certmanager.Client, string) error) error {
...
func withClient(ctx server.Cmd, authenticated bool, fn func(*certmanager.Client, string) error) error {
